...
import millaav.quantumupgrade.common.container.ContainerQGenerator;
import millaav.quantumupgrade.common.network.PacketGUIPressButton;
...
public class GuiQGenerator extends GuiContainer implements KeyListener {
    public Minecraft mc;
    public TileQGenerator tileentity;
    private GuiTextField maxPacketSizeEdit;
    private GuiTextField productonEdit;
    private static ResourceLocation tex = new ResourceLocation("quantumupgrade", "textures/gui/GUIQuantumGenerator.png");

    public GuiQGenerator(InventoryPlayer inventoryplayer, TileQGenerator tileentityqgenerator) {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
        ...
        if (tex == null) {
            tex = new ResourceLocation("quantumupgrade", "textures/gui/GUIQuantumGenerator.png");
            QuantumUpgrade.addLog("Quantum Generator GUI texture is null? How could that happen?!");
        }
