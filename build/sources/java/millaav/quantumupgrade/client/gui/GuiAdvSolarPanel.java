...
import millaav.quantumupgrade.common.container.ContainerSolarPanel;
...
public class GuiAdvSolarPanel extends GuiContainer {
    public TileSolarPanel tileentity;
    private static ResourceLocation tex = new ResourceLocation("quantumupgrade", "textures/gui/GUIAdvancedSolarPanel.png");

    public GuiAdvSolarPanel(InventoryPlayer inventoryplayer, TileSolarPanel tileentitysolarpanel) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        String storageString = I18n.format("gui.quantumupgrade.storage", new Object[0]) + ": ";
        String maxOutputString = I18n.format("gui.quantumupgrade.maxOutput", new Object[0]) + ": ";
        String generatingString = I18n.format("gui.quantumupgrade.generating", new Object[0]) + ": ";
        String energyPerTickString = I18n.format("gui.quantumupgrade.energyPerTick", new Object[0]);
