...
import millaav.quantumupgrade.common.network.IHasButton;
...
public class TileQGenerator extends TileBase implements IEnergyTile, IWrenchable, IEnergySource, IHasButton {
    ...
    public TileQGenerator() {
        this.production = QuantumUpgrade.qgbaseProduction;
        this.maxPacketSize = QuantumUpgrade.qgbaseMaxPacketSize;
    ...
    public double getOfferedEnergy() {
        this.getActive();
        return !this.active ? (double)this.production : 0.0;
    }
