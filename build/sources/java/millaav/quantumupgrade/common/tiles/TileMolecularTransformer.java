...
import millaav.quantumupgrade.common.network.IReceiveServerEvents;
import millaav.quantumupgrade.common.network.PacketChangeState;
...
public class TileMolecularTransformer extends TileBase implements IEnergyTile, IWrenchable, IInventory, IEnergySink, ISidedInventory, INetworkDataProvider, INetworkUpdateListener, INetworkTileEntityEventListener, IReceiveServerEvents {
    ...
    public double getDemandedEnergy() {
        if (!this.doWork) {
            ...
            return this.lastRecipeEnergyPerOperation - this.lastRecipeEnergyUsed >= 0 ? (double)(this.lastRecipeEnergyPerOperation - this.lastRecipeEnergyUsed) : 0.0;
        }
    }
