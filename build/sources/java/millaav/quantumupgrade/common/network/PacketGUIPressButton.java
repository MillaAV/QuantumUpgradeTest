...
public class PacketGUIPressButton extends IPacket {
    ...
    public static void issue(TileEntity te, int buttonID) {
        millaav.quantumupgrade.common.network.PacketGUIPressButton pgpb = new millaav.quantumupgrade.common.network.PacketGUIPressButton();
        pgpb.x = te.xCoord;
        pgpb.y = te.yCoord;
        pgpb.z = te.zCoord;
        pgpb.dimID = te.getWorldObj().provider.dimensionId;
        pgpb.buttonID = buttonID;
        millaav.quantumupgrade.common.network.ASPPacketHandler.sendToServer(pgpb);
    }
    ...
    public void execute() {
        try {
            ...
            if (ws != null) {
                ...
                if (te != null && te instanceof millaav.quantumupgrade.common.network.IHasButton) {
