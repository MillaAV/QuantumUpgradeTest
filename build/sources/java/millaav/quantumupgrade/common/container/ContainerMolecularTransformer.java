package millaav.quantumupgrade.common.container;

import millaav.quantumupgrade.common.tiles.TileMolecularTransformer;
import millaav.quantumupgrade.common.utils.MySlot;
...
public class ContainerMolecularTransformer extends Container {
    private TileMolecularTransformer tileentity;
    ...
    public ContainerMolecularTransformer(InventoryPlayer inventoryplayer, TileMolecularTransformer tileentitymoleculartransformer) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
        ...
        int mySlotsCount = 2;
        int mainInventorySlotsStart = mySlotsCount;
        int mainInventorySlotsEnd = 27 + mySlotsCount;
        int hotBarSlotStart = mainInventorySlotsEnd;
