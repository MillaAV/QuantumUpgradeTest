package millaav.quantumupgrade.client.renderers.tile;
...
public class TileMolecularTransformerRenderer extends TileEntitySpecialRenderer {
    private static final ResourceLocation transfTextloc = new ResourceLocation("quantumupgrade", "textures/models/textureMolecularTransformer.png");
    private static final ResourceLocation plazmaTextloc = new ResourceLocation("quantumupgrade", "textures/models/plazma.png");
    private static final ResourceLocation particlesTextloc = new ResourceLocation("quantumupgrade", "textures/models/particles.png");
    public final millaav.quantumupgrade.client.renderers.tile.ModelMolecularTransformer model = new millaav.quantumupgrade.client.renderers.tile.ModelMolecularTransformer();
    ...
    public static int getTextureSize(String s, int dv) {
        if (textureSizeCache.get(Arrays.asList(s, dv)) != null) {
            ...
            try {
                InputStream inputstream = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("quantumupgrade", s)).getInputStream();
                if (inputstream == null) {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        this.renderTileEntityAt((TileMolecularTransformer)te, x, y, z, scale);
    }

    public void renderTileEntityAt(TileMolecularTransformer tileTransformer, double x, double y, double z, float scale) {
        GL11.glPushMatrix();
