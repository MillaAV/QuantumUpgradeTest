...
public class TileSolarPanel extends TileBase implements IEnergyTile, IWrenchable, IEnergySource, IInventory, INetworkDataProvider, INetworkUpdateListener {
    ...
    public TileSolarPanel(String gName, int typeSolar, int gDay, int gNight, int gOutput, int gmaxStorage) {
