...
public class ConfigVajraPro {
    ...
    public static NBTTagCompound getProfileCompound(ItemStack stack) {
        int profile = ConfigVajraPro.getInteger(stack);
        NBTTagCompound stackCompound = ConfigVajraPro.getCompound(stack);
    ...
    public static void syncConfig() {
        try {
            ...
            ConfigVajraPro.error("Unable to load Config");
