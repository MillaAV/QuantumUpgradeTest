...
public class ItemGoldBattery extends BaseElectricItem {
    public double transferLimit;
    public int tier;

    public ItemGoldBattery() {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        for(int index = 0; index < indexCount; ++index) {
            this.textures[index] = iconRegister.registerIcon("quantumupgrade" + ":" + textureFolder + this.getTextureName(index));
        }
