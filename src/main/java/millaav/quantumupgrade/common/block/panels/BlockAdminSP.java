...
import millaav.quantumupgrade.common.tiles.TileAdminSolarPanel;
...
public class BlockAdminSP extends AbstractSSP {
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.icons[0] = reg.registerIcon("quantumupgrade:admsp_side");
        this.icons[1] = reg.registerIcon("quantumupgrade:admsp_top");
        this.icons[2] = reg.registerIcon("quantumupgrade:admsp_bottom");
    }
